...
All commands:
    ...
    licenses, link, ll, login, logout, ls, org, outdated, owner,
    pack, ping, pkg, prefix, profile, prune, publish, query,
    rebuild, repo, restart, root, run, sbom, search, set,
...
All commands:
    ...
    install,
    install-ci-test,
    install-test, licenses,
    link, ll, login, logout,
    ls, org, outdated,
    owner, pack, ping, pkg,
...
All commands:
    ...
    install-test, licenses,
    link, ll, login, logout,
    ls, org, outdated, owner,
    pack, ping, pkg, prefix,
...
All commands:
    ...
    edit, exec, explain, explore, find-dupes, fund, get, help,
    help-search, init, install, install-ci-test, install-test,
    licenses, link, ll, login, logout, ls, org, outdated,
    owner, pack, ping, pkg, prefix, profile, prune, publish,
    query, rebuild, repo, restart, root, run, sbom, search,
    set, shrinkwrap, star, stars, start, stop, team, test,
    token, undeprecate, uninstall, unpublish, unstar, update,
    version, view, whoami

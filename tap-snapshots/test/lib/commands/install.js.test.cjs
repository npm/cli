...
verbose stack     at Install.checkDevEngines ({CWD}/lib/base-cmd.js:251:27)
verbose stack     at MockNpm.execCommandClass ({CWD}/lib/npm.js:312:7)
verbose stack     at MockNpm.exec ({CWD}/lib/npm.js:211:9)

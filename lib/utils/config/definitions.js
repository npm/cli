...
define('audit', {
  ...
  description: `
    ...
    default registry and all registries configured for scopes. When passed a
    dependency name an audit will be submitted for only that dependency. See
    the documentation for [\`npm audit\`](/commands/npm-audit) for details on
    what is submitted.
  `,
  flatten,
})

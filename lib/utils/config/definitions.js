...
define('strategy', {
  ...
  description: `
    ...
    the highest possible directory.
    The \`isolated\` strategy flat installs packages in \`node_modules/.store\`
    and links each version in each dependency level, including workspaces.
  `,
  flatten,
})

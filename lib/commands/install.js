...
const cliOnlyFlag = require('../utils/cli-only-flag.js')
...
class Install extends ArboristWorkspaceCmd {
  ...
  async exec (args) {
    ...
    const opts = {
      ...
      allowUnusedPatches: cliOnlyFlag(this.npm.config, 'allow-unused-patches'),
      ignorePatchFailures: cliOnlyFlag(this.npm.config, 'ignore-patch-failures'),
    }

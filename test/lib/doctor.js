...
test('node versions', t => {
  ...
  nodeVersions.forEach(({ version }) => {
    t.test(`${version}:`, vt => {
      ...
      vt.test(`${version}: npm doctor checks ok`, st => {
      ...
      vt.test('npm doctor supports silent', st => {
        const dir = st.testdir()
        npm.cache = npm.flatOptions.cache = dir
        npm.localDir = dir
        npm.globalDir = dir
      ...
      vt.test('npm doctor supports color', st => {
        const dir = st.testdir()
        npm.cache = npm.flatOptions.cache = dir
        npm.localDir = dir
        npm.globalDir = dir
      ...
      vt.test('npm doctor ping error E{3}', st => {
        const dir = st.testdir()
        npm.cache = npm.flatOptions.cache = dir
        npm.localDir = dir
        npm.globalDir = dir
      ...
      vt.test('npm doctor generic ping error', st => {
        const dir = st.testdir()
        npm.cache = npm.flatOptions.cache = dir
        npm.localDir = dir
        npm.globalDir = dir
      ...
      vt.test('npm doctor outdated npm version', st => {
        const dir = st.testdir()
        npm.cache = npm.flatOptions.cache = dir
        npm.localDir = dir
        npm.globalDir = dir
      ...
      vt.test('npm doctor file permission checks', st => {
        const dir = st.testdir({
          cache: {
            one: 'one',
      ...
      vt.test('npm doctor missing git', st => {
        const dir = st.testdir()
        npm.cache = npm.flatOptions.cache = dir
        npm.localDir = dir
        npm.globalDir = dir
      ...
      vt.test('npm doctor cache verification showed bad content', st => {
        const dir = st.testdir()
        npm.cache = npm.flatOptions.cache = dir
        npm.localDir = dir
        npm.globalDir = dir
      ...
      vt.test('npm doctor cache verification showed reclaimed content', st => {
        const dir = st.testdir()
        npm.cache = npm.flatOptions.cache = dir
        npm.localDir = dir
        npm.globalDir = dir
      ...
      vt.test('npm doctor cache verification showed missing content', st => {
        const dir = t.testdir()
        npm.cache = npm.flatOptions.cache = dir
        npm.localDir = dir
        npm.globalDir = dir
      ...
      vt.test('npm doctor not using default registry', st => {
        const dir = st.testdir()
        npm.cache = npm.flatOptions.cache = dir
        npm.localDir = dir
        npm.globalDir = dir
...
test('outdated node version', vt => {
  ...
  vt.test('npm doctor outdated nodejs version', st => {
    const dir = st.testdir()
    npm.cache = npm.flatOptions.cache = dir
    npm.localDir = dir
    npm.globalDir = dir

// mixin implementing the reify and rebuild methods
...
module.exports = cls => class Reifier extends cls {
  ...
  // Arborist.rebuild({path = this.path}) will do all the binlinks and bundle building needed.  Called by reify, and by `npm rebuild`.

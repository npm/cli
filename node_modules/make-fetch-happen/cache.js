...
module.exports = class Cache {
  ...
  put (req, response, opts) {
    ...
    if (fitInMemory) {
      ...
      const tee = new class extends Minipass {
        emit (ev, ...args) {
          if (ev === 'resume' || ev === 'end' || ev === 'data') {
            log.warn(`TEE EMIT ${ev}`, req.url, response.status, this.flowing, [...this.pipes].map(p => p.dest))
          }

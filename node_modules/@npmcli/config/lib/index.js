...
class Config {
  ...
  async [_loadFile] (file, type) {
    ...
    console.error('whats readFile?', typeof readFile)
  ...
  async loadLocalPrefix () {
    ...
    // if we have a workspace-root set at this point, then that's
    // our local prefix, and walkup sets the --workspace config.
    const wsRoot = this[_get]('workpace-root')
